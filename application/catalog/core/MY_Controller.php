...
// this class is used for the common functionality
class MY_Controller extends CI_Controller {

    function __construct() {
        parent::__construct();

        // check the user session and the url verification
        ...
        // get and set all the common variables
        $this->data['name'] = $user[0]['name'];
        $this->data['email'] = $user[0]['email'];
        $this->data['firstname'] = $user[0]['name'];
        $this->data['lastname'] = $user[0]['name'];
        $this->data['mobile_no'] = $user[0]['contact_no'];
        ...
        $this->data['site_name'] = $this->data['general_setting'][0]['setting_value'];
        $this->data['site_email'] = $this->data['general_setting'][1]['setting_value'];
        $this->data['site_address'] = $this->data['general_setting'][2]['setting_value'];
        $this->data['site_contact'] = $this->data['general_setting'][3]['setting_value'];
        $this->data['sem_linkedin'] = $this->data['general_setting'][5]['setting_value'];
        $this->data['sem_instagram'] = $this->data['general_setting'][6]['setting_value'];
        $this->data['sem_facebook'] = $this->data['general_setting'][7]['setting_value'];
        $this->data['sem_twitter'] = $this->data['general_setting'][8]['setting_value'];
        $this->data['googlesetting'] = $this->common->selectRecordById('settings', 11, 'setting_id');

        // load all the seo setting
        $this->data['seo'] = $this->common->select_data_by_condition('meta_info', array(), 'setting_value', 'setting_id', 'ASC', '', '', array());
        $this->data['seo_title'] = $this->data['seo'][0]['setting_value'];
        $this->data['seo_keyword'] = $this->data['seo'][1]['setting_value'];
        $this->data['seo_description'] = $this->data['seo'][2]['setting_value'];
    }

    // this function is used for the date diffrenace
