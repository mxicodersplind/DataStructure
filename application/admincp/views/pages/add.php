                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <?php echo form_open('Pages/addnew/', array('id' => 'addfrm', 'class' => '', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group"> <label for="">Description <span class="error">*</span></label>
                                                    <textarea id="description" rows="10" name="description" class="textarea_editor form-control form-control-lg form-control-solid"></textarea>
                                                </div>
                                            </div>

                                        </div>
                                        <button type="submit" class="btn btn-primary waves-effect waves-light m-t-10">Save</button>
